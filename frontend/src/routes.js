...
export default function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/projects/:projectId/settings-files/:fileId" element={<FileDetail apiBase="settings-files" displayPathPrefix="settings.py" />} />
      <Route path="/projects/:projectId/url-files/:fileId" element={<FileDetail apiBase="url-files" displayPathPrefix="urls.py" />} />
      <Route path="/projects/:projectId/apps/:appId/:fileType/:fileId" element={<FileDetail />} />
      <Route path="/projects/:projectId/project-files/:fileId" element={<FileDetail apiBase="project-files" />} />
      <Route path="/projects/:projectId/apps/:appId/app-files/:fileId" element={<FileDetail apiBase="app-files" displayPathPrefix="app" />} />

      {/* Static files */}
      <Route path="/projects/:projectId/static-files" element={<StaticFilesPage fileType="static" isApp={false} />} />
      <Route path="/projects/:projectId/apps/:appId/static-files" element={<StaticFilesPage fileType="static" isApp={true} />} />
      <Route path="/apps/:appId/static-files" element={<StaticFilesPage fileType="static" isApp={true} />} />

      {/* Media files */}
      <Route path="/projects/:projectId/media-files" element={<MediaFilesPage isApp={false} />} />
      <Route path="/projects/:projectId/apps/:appId/media-files" element={<MediaFilesPage isApp={true} />} />
      <Route path="/apps/:appId/media-files" element={<MediaFilesPage isApp={true} />} />

      {/* Template files */}
      <Route path="/projects/:projectId/template-files" element={<TemplateFilesPage isApp={false} />} />
      <Route path="/projects/:projectId/apps/:appId/template-files" element={<TemplateFilesPage isApp={true} />} />
      <Route path="/apps/:appId/template-files" element={<TemplateFilesPage isApp={true} />} />
